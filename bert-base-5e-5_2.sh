...
--output_dir "experiment/multi_ep3_lr5e-5_dp3" \
--do_train \
--do_eval \
--do_lower_case \
...
--data_dir "molweni/Molweni/MRC" \
--version_2_with_negative \
--output_dir "experiment/multi_ep4_lr5e-5_dp3" \
--do_train \
--do_eval \
--do_lower_case \
--overwrite_output_dir \
...
--data_dir "molweni/Molweni/MRC" \
--version_2_with_negative \
--output_dir "experiment/multi_ep2_lr5e-5_dp3_mrc" \
--do_train \
--do_eval \
--do_lower_case \
--overwrite_output_dir \
...
--data_dir "molweni/Molweni/MRC" \
--version_2_with_negative \
--output_dir "experiment/multi_ep2_lr5e-5_dp3_dp" \
--do_train \
--do_eval \
--do_lower_case \
--overwrite_output_dir \
